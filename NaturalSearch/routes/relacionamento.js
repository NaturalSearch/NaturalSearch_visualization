            ...
            for (i = 0; i < count; i++) {
                result.records[i]._fields.forEach(function (r) {
                    if (r.labels == 'Nó_Projeto') {
                        ...
                        nodes.push({ id: "valor" + i, valor_aprovado: r.properties.valor_aprovado.toString(), group: i + 1, group_color: 6, length_node: 15 });
                        ...
                        nodes.push({ id: "valor_projeto" + i, valor_projeto: r.properties.valor_projeto.toString(), group: i + 1, group_color: 12, length_node: 15 });
                        nodes.push({ id: "valor_solicitado" + i, valor_solicitado: r.properties.valor_solicitado.toString(), group: i + 1, group_color: 13, length_node: 15 });
                        nodes.push({ id: "valor_captado" + i, valor_captado: r.properties.valor_captado.toString(), group: i + 1, group_color: 14, length_node: 15 });
