...
router.get('/', function (req, res, next) {
    ...
    for (i = 0; i <= 100; i++) {
        ...
        session
            .run('CREATE(n:Proponentes_final{tipo_pessoa:{tipo_pessoa},uf:{uf},municipio:{municipio},nome:{nome}}) RETURN n.nome', {
                tipo_pessoa: tipo_pessoa,uf:uf,municipio:municipio,nome: nome
            })
